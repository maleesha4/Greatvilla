  ...
  return (
    <div style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto' }}>
      <div className="glass" style={{ padding: '40px', borderRadius: '12px', border: '1px solid var(--border-color)' }}>
        <h1 style={{ color: 'var(--primary)', marginBottom: '20px', fontSize: '2.5rem' }}>BookingHistory</h1>
        <p style={{ color: 'var(--text-gray)', fontSize: '1.1rem', lineHeight: '1.8' }}>
          Welcome to the BookingHistory page. This section provides a detailed view of bookinghistory configurations for Greatvilla Luxury Hotel Management.
        </p>
